...
public class RvNetworkSubjectDetailAdapter extends BaseQuickAdapter<NetworkSubject, BaseViewHolder> {

    public RvNetworkSubjectDetailAdapter(int layoutResId, @Nullable List<NetworkSubject> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, NetworkSubject item) {
