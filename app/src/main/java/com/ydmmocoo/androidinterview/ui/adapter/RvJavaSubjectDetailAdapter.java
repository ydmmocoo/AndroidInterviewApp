...
public class RvJavaSubjectDetailAdapter extends BaseQuickAdapter<JavaSubject, BaseViewHolder> {

    public RvJavaSubjectDetailAdapter(int layoutResId, @Nullable List<JavaSubject> data) {
