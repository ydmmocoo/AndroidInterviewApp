...
public class RvOpenSourceSubjectDetailAdapter extends BaseQuickAdapter<OpenSourceSubject, BaseViewHolder> {

    public RvOpenSourceSubjectDetailAdapter(int layoutResId, @Nullable List<OpenSourceSubject> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, OpenSourceSubject item) {
