...
public class RvAlgorithmSubjectDetailAdapter extends BaseQuickAdapter<AlgorithmSubject, BaseViewHolder> {

    public RvAlgorithmSubjectDetailAdapter(int layoutResId, @Nullable List<AlgorithmSubject> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, AlgorithmSubject item) {
